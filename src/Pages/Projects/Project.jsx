...
const Project = ({name, description, technology, liveLink, clientRepo, serverRepo}) => {
    return (
        <div className="rounded-3xl border-2 bg-[#272727] border-[#8aa8d367] text-[#263c6e] ">
                    ...
                    <div className="p-4">
                        <Link to='https://assetify-a3e7d.web.app/' target="_blank"><p className="text-2xl font-rowdies text-[#8aa8d3] hover:text-[#38BDF8]">{name}</p></Link>
    
                        <p className="mt-2 font-bai text-lg text-[#92a2b8]"><span className="font-semibold">Description:</span> {description}</p>
                        ...
                        <p className="mt-3 text-lg text-[#92a2b8] font-bai font-semibold"><span className="">Technology used</span> : {technology}</p>
                        <div className="mt-5 text-lg font-bai text-[#38BDF8] font-semibold flex gap-5">

        ...
        <div className="bg-[#0F172A] py-10" id="projects" >
            ...
            <div className="max-w-[1280px] mx-auto lg:px-10 sm:px-8 px-2 py-10 text-white font-bai grid lg:grid-cols-3 md:grid-cols-2 gap-5">
                ...
                <div className="text-[#92a2b8] border border-[#5d697a79] rounded-sm p-4">
                    ...
                    <p className="mt-2"><span className="font-semibold">Description:</span> This project is a digital solution to manage all assets of an office. Creating connections between HR managers and employees to digitally manage employee asset issuance and returns information and through this HR manager can easily keep track of all assets. This saves a lot of time and reduces the chances of losing assets.</p>
                    ...
                    <p className="mt-3 font-semibold"><span className="">Technology used</span> : Tailwind, Javascript, React, Express JS, MongoDB</p>
                ...
                <div className="text-[#92a2b8] border border-[#5d697a79] rounded-sm p-4">
                    ...
                    <p className="mt-2"><span className="font-semibold">Description:</span> This is a project that provides detailed information about various tourist places in South Asia. It will help you to know detailed information about all tourist spots in South Asia. It can also be called tourism spot sharing platform. Here anyone can share details about any spot in South Asia.</p>
                    ...
                    <p className="mt-3 font-semibold"><span>Technology used :</span> Tailwind, Javascript, React, Express JS, MongoDB</p>
                    <div className="mt-5 font-semibold flex gap-5">
                ...
                <div className="text-[#92a2b8] border border-[#5d697a79] rounded-sm p-4">
                    ...
                    <p className="mt-2"><span className="font-semibold">Description:</span> This website serves as a comprehensive management tool for the school library, facilitating students to book loans and returns through this system. This digital platform streamlines the process of managing library resources, ensuring accurate records, and reducing administrative workload.</p>
